      ...
      <div>
        ...
        <section class="what-we-do py-5">
          <div class="container py-md-5">
            <h3 class="heading text-center mb-3 mb-sm-5">Style kami</h3>
            <div class="row what-we-do-grid">
              ...
              <div class="col-lg-3 col-md-6 bg-grid-clr">
                <h4 class="mt-md-0 my-2">Guntingan rambut</h4>
                <p class="">Modern .</p>
              </div>
              ...
              <div class="col-lg-3 col-md-6 bg-grid-clr mt-lg-0 mt-md-4">
                <h4 class="mt-md-0 my-2">Cukur</h4>
                <p class="">Classic .</p>
              </div>
              ...
              <div class="col-lg-3 col-md-6 bg-grid-clr mt-lg-5 mt-md-4">
                <h4 class="mt-md-0 my-2">Cukur brewok</h4>
                <p class="">Modern .</p>
              </div>
              <div class="col-lg-3 col-md-6 pr-0 pl-md-3 pl-0 mt-lg-5 mt-4">
              ...
              <div class="col-lg-3 col-md-6 bg-grid-clr mt-lg-5 mt-md-4">
                <h4 class="mt-md-0 my-2">Cukur kumis</h4>
                <p class="">Classic.</p>
              </div>
            </div>
          </div>
